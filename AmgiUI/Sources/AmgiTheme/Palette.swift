...
public struct Palette: Sendable, Equatable {
    ...
    public static func resolve(theme: Theme, scheme: ColorScheme) -> Palette {
        ...
        case (.legacy, .light): return .legacyLight
        case (.legacy, .dark): return .legacyDark
...
// MARK: - Legacy (Old Amgi)

public extension Palette {
    static let legacyLight = Palette(
        background: .hex(0xF2F2F7),
        surface: .white,
        surfaceElevated: .white,
        border: .hex(0xD1D1D6),
        textPrimary: .hex(0x1D1D1F),
        textSecondary: Color.hex(0x1D1D1F).opacity(0.72),
        textTertiary: Color.hex(0x1D1D1F).opacity(0.52),
        accent: .hex(0x1A73E0),
        link: .hex(0x0563D6),
        positive: .hex(0x34C759),
        warning: .hex(0xFF9500),
        danger: .hex(0xFF3B30),
        info: .hex(0x32ADE6),
        customStudyBadge: .hex(0xFF9500)
    )

    static let legacyDark = Palette(
        background: .black,
        surface: .hex(0x1C1C1E),
        surfaceElevated: .hex(0x24262E),
        border: Color.white.opacity(0.12),
        textPrimary: .white,
        textSecondary: Color.white.opacity(0.82),
        textTertiary: Color.white.opacity(0.66),
        accent: .hex(0x59ADFF),
        link: .hex(0x7AC7FF),
        positive: .hex(0x63DB8A),
        warning: .hex(0xFFB84A),
        danger: .hex(0xFF7A7A),
        info: .hex(0x70D6F2),
        customStudyBadge: .hex(0xFFB84A)
    )
}
