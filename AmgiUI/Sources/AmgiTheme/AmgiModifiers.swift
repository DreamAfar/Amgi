...
extension View {
    public func amgiCard(elevated: Bool = false) -> some View {
    ...
    public func amgiCapsuleControl(
    ...
    public func amgiStatusBadge(_ tone: AmgiStatusTone, horizontalPadding: CGFloat = 8, verticalPadding: CGFloat = 4) -> some View {
    ...
    public func amgiStatusPanel(_ tone: AmgiStatusTone, elevated: Bool = false) -> some View {
        padding(AmgiSpacing.lg)
            .background(
    ...
    public func amgiSegmentedPicker() -> some View {
        pickerStyle(.segmented)
            .tint(Color.amgiAccent)
    }

    public func amgiSectionBackground() -> some View {
